...
public class SearchController {
    ...
    public String search(String bt, Model model,Integer nowPage) throws IOException, ParseException, InvalidTokenOffsetsException {
        if(bt!=""){

            FSDirectory fsDirectory = FSDirectory.open(Paths.get("E:\\index\\06"));
            ...
            Query query = null;
            query = queryParser.parse(bt);

//888888888888                TopDocs topDocs = indexSearcher.search(query, 10);
